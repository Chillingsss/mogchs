...
export default function RegistrarDashboard() {
	...
	return (
		<div className="flex min-h-screen bg-slate-50">
			...
			{/* Sidebar */}
			<aside
				className={`fixed lg:relative z-30 flex flex-col p-4 space-y-6 bg-slate-900 dark:bg-slate-900 text-white dark:text-white transition-all duration-300 h-full lg:h-auto ${
					sidebarOpen
						? "w-64 translate-x-0"
			...
			>
				{/* Toggle button */}
				<button
					className="flex justify-center items-center mb-4 w-10 h-10 text-white bg-blue-600 rounded hover:bg-blue-700 dark:hover:bg-slate-800 focus:outline-none"
					style={{ color: "white" }}
