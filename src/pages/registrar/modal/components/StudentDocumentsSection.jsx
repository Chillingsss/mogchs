...
const StudentDocumentsSection = ({ studentDocuments, request }) => {
	// Function to handle file access errors
							...
							<div className="flex gap-3 items-center p-4">
								...
								<div className="flex-1 min-w-0">
									...
									<div className="flex gap-2">
										<a
											href={`http://localhost/mogchs/backend/documents/${document.fileName}`}
											target="_blank"
										...
										<button
											onClick={() => {
												const printWindow = window.open(
													`http://localhost/mogchs/backend/documents/${document.fileName}`,
													"_blank"
												);
												if (printWindow) {
													printWindow.onload = () => {
	...
	return (
		<div className="p-4 rounded-lg border-2 border-dashed border-amber-200 bg-amber-50">
